...
const FoodCard = ({ food, className='' }) => {
  ...
  return (
    <div className={`lg:max-w-[300px] lg:h-[100px] bg-gradient-to-br from-dark-gray via-gray-800 to-dark-gray rounded-lg shadow-majestic hover:shadow-xl transition duration-300 ${className}`}>
